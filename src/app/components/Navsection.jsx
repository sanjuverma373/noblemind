                ...
                <div className='py-[19px] absolute top-0 left-0 w-full'>
                        <div className=' container px-3 mx-auto'>
                                <div className=' flex items-center justify-between'>
                                        ...
                                        <ul className={`${first ? "left-0" : "left-[-100%]"} flex items-center duration-300 justify-center gap-4 max-lg:flex-col max-lg:w-full max-lg:h-full max-lg:fixed max-lg:top-0 max-lg:z-20 max-lg:bg-white max-lg:over`}>
